...
<div class="w3-top">
  <div class="w3-bar w3-yellow w3-card">
    ...
    <a href="temp.html" class="btn btn-info w3-red w3-large w3-hover-green" role="button" style="float: right; margin-top: 23px; margin-right: 12px; border: none;">Register</a>
...
<div class="w3-content w3-bar-block w3-grey" style="float: right;width:199px;height:768px;" id="s">
  ...
  <a href="datacard1.html" class="w3-bar-item w3-button w3-hover-green">DataCard</a><br>
    <a href="spreg.php" class="w3-bar-item w3-button w3-hover-green">Service Provider</a><br>
     <a href="adlog.php" class="w3-bar-item w3-button w3-hover-green">Admin Login</a><br>
 </div>
...
;" placeholder="+91 enter valid Number" maxlength="10" pattern="[6789][0-9]{9}"  required><br>
		 <input type="radio" onclick="javascript:j1();" name="service" value="Prp" style="margin:25px;" id="yesc" checked> Prepaid 
		 <input type="radio" onclick="javascript:j1();" name="service" value="Pop" style="margin:25px;" id="noc"> Postpaid  
     <input type="submit"  value="Proceed" class="btn btn-info w3-red w3-large w3-hover-blue" role="button" style="float: right; margin-top: 12px; margin-left: 100px; border: none;"><br>

		
    <div id="ifYes">
		<select name="operator" style=" color: #1815D2; background-color: #eeeeee; border-radius: 5px; border: solid 0.5px; border-color: #FFC300  
;">
	...
	<select name="circle" style="color: #1815D2; background-color: #eeeeee; border-radius: 5px; margin-left: 50px; border: solid 0.5px; border-color: #FFC300  
;">
	...
	<div id="ifno" style="display:none;">
		<select name="operator1" style="color: #1815D2; background-color: #eeeeee; border-radius: 5px; border: solid 0.5px; border-color: #FFC300  
;">
  				<option value="Operator">Operator</option>
  				<option value="aircel">Aircel</option>
  				<option value="airtel">Airtel</option>
...
<div class="w3-container" style="width:73%; margin-left:175px;" >
  <h2 style="text-align: center;">Offers For You</h2>
