...
<body>
  ...
  <div class="w3-bar w3-yellow w3-card">
	...
	<h3 style="margin-top:100px;">
		You Should enter the amount In order to Recharge Successfully.<br>
		<a href="https://www.komparify.com/compare-dth-packages-offers" target="blank"><span style="font-size: 40px;">Link For DTH Recharge plans of different Service Providers.</span></a>
	</h3><br>
<div id=cent>
  
<p style="font-size: 20px; text-align:center; "><b>Checkout For DTH Recharge</b></p>

	<form>Enter Amount:<input type="text" name="Phone Number" style="border: solid black 1px; border-radius: 5px; border: solid 0.5px; border-color: #FFC300  
;" placeholder="Amount"  required>
		   <a href="credit.php" class="btn btn-info w3-red w3-large w3-hover-blue" role="button" style="float: right; margin-top: 12px; margin-left: 100px; border: none;">Proceed For Payment</a><br>
</form>
 ...
 <div class="w3-content" style="width:900px; margin-left:11px; margin-top:100px; border: solid 0.75px;">
   ...
   <img class="mslides" src="rech.jpg" style="width:100%">
    <img class="mslides" src="bsnl.jpg" style="width:100%">
     <img class="mslides" src="docom.png" style="width:100%">
