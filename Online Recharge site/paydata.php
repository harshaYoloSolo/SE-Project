...
<body>
  ...
  <div class="w3-bar w3-yellow w3-card">
	...
	<h3 style="margin-top:100px;">
		You Should enter the amount In order to Recharge Successfully,Offers are same for datacard as mobile offers to know offers please visit the link below.
		
	</h3><br>
<div id=cent>
  
<p style="font-size: 20px; text-align:center; "><b>Checkout For DataCard Recharge</b></p>
...
;" placeholder="Amount"  required>
		   <input type="submit" class="btn btn-info w3-red w3-large w3-hover-blue"  style="float: right; margin-top: 12px; margin-left: 100px; border: none;"><br>

		
  
	</form>
   <a href="https://www.plansinfo.com/" target="blank"><span style="font-size: 25px;">Link For DataCard Recharge plans of different Service Providers.</span></a>
